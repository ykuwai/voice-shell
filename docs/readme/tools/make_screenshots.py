...
SAMPLES = {
    ...
    "ja": {
        ...
        "sent": [
            ...
            ("10:44:52", 0, True, "パスワードに + が入っているとログインに失敗する。どこでエンコードしているか探して直して。"),
            ("10:46:30", 0, False, "もう一度テストを回して、まだ落ちているものを教えて。"),
        ],
        "partial": "それと + のケースの回帰テストも追加して",
    ...
    "ko": {
        ...
        "sent": [
            ...
            ("10:44:52", 0, True, "비밀번호에 + 기호가 있으면 로그인이 실패해. 인코딩하는 곳을 찾아서 고쳐 줘."),
            ("10:46:30", 0, False, "테스트를 다시 돌리고 아직 실패하는 게 뭔지 알려 줘."),
        ],
        "partial": "그리고 + 기호 경우에 대한 회귀 테스트도 추가해 줘",
