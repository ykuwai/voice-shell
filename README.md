...
While Chrome holds a model for your language, it recognizes locally. Without one, your audio is sent to Google's servers. The settings say which of the two is happening.
